...
public class MessageManager {
    ...
    public String call(Object message, Gson gson, String SessionKey, int Code, String CodeName,  String requestQueueName) throws IOException, InterruptedException {
    ...
    public String call(String message, Gson gson, String SessionKey, int Code, String CodeName,  String requestQueueName) throws IOException, InterruptedException {
        JsonParser parser = new JsonParser();
        JsonObject json_message = parser.parse(message).getAsJsonObject();
        return call(gson.toJson(new RestObject(json_message, SessionKey, Code), RestObject.class),requestQueueName);
    }
    
    public String call(JsonObject message, Gson gson, String SessionKey, int Code, String CodeName,  String requestQueueName) throws IOException, InterruptedException {
