...
public class ReminderSurchargeModelConverter implements JsonSerializer<ReminderSurchargeModel>, JsonDeserializer<ReminderSurchargeModel>, InterfaceConverter {
    @Override
    public JsonElement serialize(ReminderSurchargeModel src, Type type, JsonSerializationContext jsc) {
    ...
    @Override
    public ReminderSurchargeModel deserialize(JsonElement json, Type type, JsonDeserializationContext jdc) throws JsonParseException {
        ...
        return new ReminderSurchargeModel (id, user_id, name, count, products, messages);
    }
}
