...
public class ReminderPaymentsModel implements ModelInterface {
    int id = -1;
    int user_id = -1;
    String name = "";
    int count;
    ...
    public ReminderPaymentsModel(int id, int user_id, String name, int count, ArrayList<ShortProduct> products, ArrayList<ReminderMessageView> messages) {
        this.id = id;
