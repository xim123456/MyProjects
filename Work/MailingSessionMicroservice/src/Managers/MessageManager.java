...
public class MessageManager {
    ...
    public ResData call(Object message, Gson gson, String SessionKey, int Code, String CodeName,  String requestQueueName) throws IOException, InterruptedException {
    ...
    public ResData call(String message, Gson gson, String SessionKey, int Code, String CodeName,  String requestQueueName) throws IOException, InterruptedException {
        JsonParser parser = new JsonParser();
