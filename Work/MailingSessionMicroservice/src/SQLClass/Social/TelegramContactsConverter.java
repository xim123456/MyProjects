...
public class TelegramContactsConverter implements JsonSerializer<TelegramContacts>, JsonDeserializer<TelegramContacts>, InterfaceConverter {
    @Override
    public JsonElement serialize(TelegramContacts src, Type type, JsonSerializationContext jsc) {
    ...
    @Override
    public TelegramContacts deserialize(JsonElement json, Type type, JsonDeserializationContext jdc) throws JsonParseException {
        ...
        return new TelegramContacts(id, user_id, contact_id, first_name, last_name, username, is_subscribed);
    }
}
